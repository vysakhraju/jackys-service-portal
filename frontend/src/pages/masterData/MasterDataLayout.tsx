...
const MASTER_DATA_CAPABILITIES = [
  ...
  'MASTER_DATA_BILLING_CHANNEL_MANAGE',
  'MASTER_DATA_APPOINTMENT_FIELD_CONFIG_MANAGE',
...
const TABS: { label: string; path: string }[] = [
  ...
  { label: 'Billing Channels', path: '/master-data/billing-channels' },
  { label: 'New Appointment Fields', path: '/master-data/appointment-field-config' },
